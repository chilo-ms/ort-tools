...
# TensorRT-8.5.1.7 GA, CUDA11.
export PATH=/usr/local/cuda/bin${PATH:+:${PATH}}$
#export LD_LIBRARY_PATH=/usr/local/cuda/lib64
#export LD_LIBRARY_PATH=/mnt/TensorRT-8.5.2.2/lib${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}

export PATH=~/cmake-3.26.3-linux-x86_64/bin:$PATH
